import { IToastService } from 'native-base/components/composites/Toast';
...
declare module 'native-base' {
	...
	namespace NativeBase {
		 ...
		 */
		interface Header extends ReactNative.ViewProps, Testable {
			/**
		...
		interface Left extends ReactNative.ViewProps, Testable {
			style?: RnViewStyleProp | Array<RnViewStyleProp>;
		}

		interface Body extends ReactNative.ViewProps, Testable {
			style?: RnViewStyleProp | Array<RnViewStyleProp>;
		}

		interface Right extends ReactNative.ViewProps, Testable {
			style?: RnViewStyleProp | Array<RnViewStyleProp>;
		}
		 ...
		 */
		interface Container extends ReactNative.ViewProps, Testable {
			/**
		 ...
		 */
		interface Content extends Testable, KeyboardAwareScrollViewProps, ReactNative.ViewProps {
			/**
			 * The theme prop can be applied to any component of NativeBase.
			 */
			refreshing?: boolean;
		...
		interface Card extends ReactNative.ViewProps, Testable {
			...
			renderFooter?: () => React.ReactElement<any>;
			renderHeader?: () => React.ReactElement<any>;
			renderRow?: ReactNative.ListRenderItem<any> | null | undefined;
