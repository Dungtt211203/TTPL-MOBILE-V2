...
const MenuItem = ({ children, isDisabled, onPress, textValue, ...props }: IMenuItemProps, ref: any) => {
	const { closeOnSelect, onClose, layout } = React.useContext(MenuContext);
	...
	return (
		...
		>
			<HStack {..._stack} width={layout?.width ? layout.width - 25 : 'auto'}>
