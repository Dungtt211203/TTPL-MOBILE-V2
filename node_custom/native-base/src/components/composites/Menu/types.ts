...
export type IMenuComponent = ((props: IMenuProps & { ref?: MutableRefObject<any> }) => JSX.Element) & {
	Item: React.MemoExoticComponent<(props: IMenuItemProps & { ref?: MutableRefObject<any> }) => JSX.Element>;
	Group: React.MemoExoticComponent<(props: IMenuGroupProps & { ref?: MutableRefObject<any> }) => JSX.Element>;
	ItemOption: React.MemoExoticComponent<
		(props: IMenuItemOptionProps & { ref?: MutableRefObject<any> }) => JSX.Element
	>;
	OptionGroup: React.MemoExoticComponent<
		(props: IMenuOptionGroupProps & { ref?: MutableRefObject<any> }) => JSX.Element
	>;
};
