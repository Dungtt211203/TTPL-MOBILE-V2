...
export const useMenuItem = ({ textValue, ref }: { textValue: string; ref: any }) => {
	return {
...
export const useMenuOptionItem = ({ isChecked, type }: { isChecked: boolean; type: 'checkbox' | 'radio' }) => {
	return {
		accessibilityRole: ('menuitem' + (Platform.OS === 'web' ? type : '')) as AccessibilityRole,
		accessibilityState: {
			checked: isChecked,
		},
