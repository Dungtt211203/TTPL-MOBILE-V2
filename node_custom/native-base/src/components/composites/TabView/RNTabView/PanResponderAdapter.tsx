...
import type { NavigationState, Route, Layout, EventEmitterProps, PagerProps, Listener } from './types';
...
export default function PanResponderAdapter<T extends Route>({
	...
	navigationState,
	onIndexChange,
	respondToGesture: _respondToGesture,
	onSwipeStart,
	onSwipeEnd,
	children,
	style,
	...
	const respondToGesture = (_: GestureResponderEvent, gestureState: PanResponderGestureState) => {
		...
		_respondToGesture?.(gestureState);
